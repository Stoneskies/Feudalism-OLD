                            ...
                            if (resident.hasTown()) {
                                try {
                                    ...
                                    if (RuinAPI.isRuined(resident.getTown())) {
                                        ...
                                        RuinAPI.reclaim(resident, resident.getTown());
                                ...
                                try {
                                    ...
                                    if(RuinAPI.isRuined(town)) {
                                        if(town.getNation() == cmdsender.getTown().getNation()) {
                                            ...
                                            } else {sender.sendMessage(ChatInfo.msg("That player is currently a mayor."));}
                                        } else {sender.sendMessage(ChatInfo.msg("That town is not in your nation"));}
                                    } else {sender.sendMessage(ChatInfo.msg("That town isn't ruined"));}
                                } catch (NotRegisteredException e) {
                                    e.printStackTrace();
